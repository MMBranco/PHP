...
<body>
    ...
    <?php 
        include "banco.php"; // Importanto "banco.php".
        ...
        // Inserir dados
        // "SE" Requisição do tipo POST "E" se existe uma requisiçõo chamada mensagem
        if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['mensagem'])) {
        
            $mensagem = $_POST ['mensagem'];
            $usuario = $_SESSION['usuario'] ? $_SESSION['usuario'] : 'Anônimo';

            // // Outra forma de fazer o "Anônimo"
        ...
        <div class="chat">
            <?php
                ...
                if($resultado -> num_rows > 0) {
                    // Linha armazena 1 resultado por vez escolhido pelo feth_assoc.
